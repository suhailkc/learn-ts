...
// 7. Record<K, T>
// Constructs a type with keys of type K and values of type T
...
let unknownData: unknown = 'suhail' // data being fetched from API;
const unknownValue = unknownData as string; // it's called 'type casting'. means changing type 'unknown' to 'string'
